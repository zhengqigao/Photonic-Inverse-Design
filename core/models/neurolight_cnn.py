...
class NeurOLight2d(PDE_NN_BASE):
    ...
    def __init__(
        ...
        ffn: bool = True,
        ffn_dwconv: bool = True,
        encoder_cfg: dict = {}, # dummy input for the reorganization of the code
        backbone_cfg: dict = {}, # dummy input for the reorganization of the code
        decoder_cfg: dict = {}, # dummy input for the reorganization of the code
        **kwargs,
    ):
        super().__init__(
    ...
    def forward(
        ...
        epsilon = x[:, 0:1]  # this is original permittivity, not normalized from fdtd.py
        epsilon_max = torch.max(epsilon)
        epsilon_min = torch.min(epsilon)
