...
LastEditTime: 2023-09-19 20:41:25
'''
import os
import subprocess
...
if __name__ == '__main__':
    ...
    # scan gaussian noise
    tasks1 = [
        ["mae", True, 0.005, 0.0,   0.0, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.03, 0.03, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.05, 0.05, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.07, 0.07, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.09, 0.09, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.11, 0.11, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.15, 0.15, 1,   1,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0.2,   0.2, 1,   1,   "fp32", "fp32", 100, 1],
    ][::-1]

    # scam downsampling factor
    tasks2 = [
        # ["mae", True, 0.005, 0, 0, 0.8,0.8,   "fp32", "fp32", 100, 1],
        # ["mae", True, 0.005, 0, 0, 0.7,0.7,   "fp32", "fp32", 100, 1],
        # ["mae", True, 0.005, 0, 0, 0.6,0.6,   "fp32", "fp32", 100, 1],
        # ["mae", True, 0.005, 0, 0, 0.5,0.5,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0, 0, 0.4,0.4,   "fp32", "fp32", 100, 1],
        ["mae", True, 0.005, 0, 0, 0.333,0.333,   "fp32", "fp32", 100, 1],
    ][::-1]


    # scan quantization precision
    tasks3 = [
        ["mae", True, 0.005, 0,    0,    1,   1,   "fp16", "fp16", 100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "bfp16","bfp16",100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "int16","int16",100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "int8", "int8", 100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "int7", "int7", 100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "int6", "int6", 100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "int5", "int5", 100, 1],
        ["mae", True, 0.005, 0,    0,    1,   1,   "int4", "int4", 100, 1],
    ]

    with Pool(8) as p:
        # p.map(task_launcher, tasks1)
        p.map(task_launcher, tasks2)
