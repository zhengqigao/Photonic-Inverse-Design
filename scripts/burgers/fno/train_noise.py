...
LastEditTime: 2023-09-19 19:35:55
'''
import os
import subprocess
...
if __name__ == '__main__':
    ...
    # scan gaussian noise
    tasks = [
        ["mae", True, 0.005, 0.0,  0.0,  1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.03, 0.03, 1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.05, 0.05, 1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.07, 0.07, 1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.09, 0.09, 1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.11, 0.11, 1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.15, 0.15, 1,   1,   "fp32", "fp32", 100, 2],
        ["mae", True, 0.005, 0.2,   0.2, 1,   1,   "fp32", "fp32", 100, 2],
    ][::-1]
