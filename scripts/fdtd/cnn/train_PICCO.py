...
if __name__ == '__main__':
    ...
    tasks = [
        [72, "PacConv2d", True, "E0_Ji", False, "max", "NO2", False, 10, 160, 80, 10, 17, 4, True, 8, 18, True, False, False, False, False, False, "Test_reorgnaized_PICCO_MMI", 0, 1, 0.002, "nL2norm", False, 0, "none", 1], # use this to train the model on mmi dataset
        # [72, "PacConv2d", True, "E0_Ji", False, "max", "NO2", False, 10, 160, 80, 10, 17, 4, True, 8, 18, True, False, False, False, False, False, "Test_reorgnaized_PICCO_MRR", 0, 100, 0.002, "nL2norm", False, 0, "none", 1], # use this to train the model on mrr dataset
        # [72, "PacConv2d", True, "E0_Ji", False, "max", "NO2", False, 10, 160, 80, 10, 17, 4, True, 8, 18, True, False, False, False, False, False, "Test_reorgnaized_PICCO_META", 0, 100, 0.002, "nL2norm", False, 0, "none", 1], # use this to train the model on metaline dataset
        ]
