...
def task_launcher(args):
    mixup, dim, alg, pac, input_mode, eps_lap, field_norm_mode, stem, include_src, fuse_lap, se, dec_act, in_frames, out_frames, out_channels, offset_frames, kernel_size, backbone_dilation, r, id, share_weight, num_shared_layers, description, gpu_id, epochs, lr, criterion, weighted_frames, criterion_weight, task, checkpt, bs, roll_out_frames = args
    ...
    suffix = f"alg-{alg}_of-{out_frames}_oc-{out_channels}_ks-{kernel_size}_di-{backbone_dilation}_r-{r}_des-{description}_task-{task}_id-{id}"
...
if __name__ == '__main__':
    ...
    tasks = [
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 50, 50, 10, 17, 2, 5, 18, False, 1, "outC50_KS17_DI2_MMI", 3, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],

        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 1, 8, 18, False, 1, "outC80_KS17_LAY8_DI1_MMI", 0, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 2, 8, 18, False, 1, "outC80_KS17_LAY8_DI2_MMI", 1, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 4, 8, 18, False, 1, "outC80_KS17_LAY8_DI4_MMI", 2, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 8, 8, 18, False, 1, "outC80_KS17_LAY8_DI8_MMI", 3, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],

        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 160, 160, 10, 17, 4, 8, 18, False, 1, "Exp7_down_outC160_KS29_LAY8_DI4_MMI", 3, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],

        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 1, 8, 18, False, 1, "outC80_KS17_LAY8_DI1_MMI_TEST_ROLL_OUT", 0, 100, 0.002, "nmse", 0, 0.1, "test_autoregressive", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-80_oc-80_ks-17_di-1_r-8_id-18_err-0.0191_epoch-97.pt", 1],

        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 1, 8, 18, False, 1, "outC80_KS17_LAY8_DI1_MMI_ITER2EXP7_TEST_SPEED", 0, 100, 0.002, "nmse", 0, 0.1, "test_speed", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-80_oc-80_ks-17_di-1_r-8_id-18_err-0.0191_epoch-97.pt", 1, 80],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 2, 8, 18, False, 1, "outC80_KS17_LAY8_DI2_MMI_TEST_SPEED", 0, 100, 0.002, "nmse", 0, 0.1, "test_speed", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-80_oc-80_ks-17_di-2_r-8_id-18_err-0.0185_epoch-97.pt", 1, 80],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 4, 8, 18, False, 1, "outC80_KS17_LAY8_DI4_MMI_TEST_SPEED", 0, 100, 0.002, "nmse", 0, 0.1, "test_speed", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-80_oc-80_ks-17_di-4_r-8_id-18_err-0.0201_epoch-97.pt", 1, 80],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 8, 8, 18, False, 1, "outC80_KS17_LAY8_DI8_MMI_TEST_SPEED", 0, 100, 0.002, "nmse", 0, 0.1, "test_speed", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-80_oc-80_ks-17_di-8_r-8_id-18_err-0.0207_epoch-97.pt", 1, 80],

        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 160, 160, 10, 17, 4, 8, 18, False, 1, "Exp7_down_outC160_KS29_LAY8_DI4_MMI_TEST_SPEED", 0, 100, 0.002, "nmse", 0, 0.1, "test_speed", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-160_oc-160_ks-17_di-4_r-8_des-Exp7_down_outC160_KS29_LAY8_DI4_MMI_id-18_err-0.0648_epoch-94.pt", 1, 160],
        # [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 80, 80, 10, 17, 1, 8, 18, False, 1, "outC80_KS17_LAY8_DI1_MMI_TEST_ROLL_OUT", 0, 100, 0.002, "nmse", 0, 0.1, "test_roll_out", "./checkpoint/fdtd/cnn/train_dw_dilation/FourierCNN_alg-Conv2d_of-80_oc-80_ks-17_di-1_r-8_id-18_err-0.0191_epoch-97.pt", 1, 160],
        ]
    # tasks = [[0, 1]]
