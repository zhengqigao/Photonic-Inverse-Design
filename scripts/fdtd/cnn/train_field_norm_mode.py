...
dataset = "fdtd"
model = "cnn"
exp_name = "train_field_norm_mode"
...
def task_launcher(args):
    mixup, dim, alg, pac, input_mode, eps_lap, field_norm_mode, stem, include_src, fuse_lap, se, dec_act, in_frames, out_frames, out_channels, offset_frames, kernel_size, propagating_filter, dilation, r, id, share_weight, num_shared_layers, description, gpu_id, epochs, lr, criterion, weighted_frames, criterion_weight, task, checkpt, bs = args
    ...
    suffix = f"alg-{alg}_norm-{field_norm_mode}_of-{out_frames}_oc-{out_channels}_ks-{kernel_size}_pf-{propagating_filter}_di-{dilation}_r-{r}_id-{id}"
    with open(os.path.join(root, f'{suffix}.log'), 'w') as wfid:
        ...
        exp = [
            ...
            f"--model.backbone_cfg.dilation_list={[dilation]*r}",
...
if __name__ == '__main__':
    ...
    tasks = [
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "avg_pool_max", "NO2", True, False, False, "GELU", 10, 20, 20, 10, 7, 0, 1, 8, 1, False, 1, "outC20_avg_max_MMI", 2, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "avg_pool_max99", "NO2", True, False, False, "GELU", 10, 20, 20, 10, 7, 0, 1, 8, 1, False, 1, "outC20_avg_max99_MMI", 3, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "rigional_std", "NO2", True, False, False, "GELU", 10, 20, 20, 10, 7, 0, 1, 8, 1, False, 1, "outC20_rigional_std_MMI", 1, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max99", "NO2", True, False, False, "GELU", 10, 20, 20, 10, 7, 0, 1, 8, 1, False, 1, "outC20_max99_MMI", 1, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 20, 20, 10, 7, 0, 1, 8, 1, False, 1, "outC20_max_MMI", 2, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "std", "NO2", True, False, False, "GELU", 10, 20, 20, 10, 7, 0, 1, 8, 1, False, 1, "outC20_std_MMI", 3, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        ]
    # tasks = [[0, 1]]
