...
dataset = "fdtd"
model = "cnn"
exp_name = "train_propagating_mask"
...
def task_launcher(args):
    ...
    suffix = f"alg-{alg}_of-{out_frames}_oc-{out_channels}_ks-{kernel_size}_pf-{propagating_filter}_di-{dilation}_r-{r}_id-{id}"
...
if __name__ == '__main__':
    ...
    tasks = [
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 50, 50, 10, 17, 71, 1, 5, 0, False, 1, "outC50_KS17_PF_DI1_MMI", 2, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        [0.0, 72, "Conv2d", False, "eps_E0_Ji", False, "max", "NO2", True, False, False, "GELU", 10, 50, 50, 10, 17, 71, 2, 5, 0, False, 1, "outC50_KS17_PF_DI2_MMI", 3, 100, 0.002, "nmse", 0, 0.1, "train", "none", 1],
        ]
    # tasks = [[0, 1]]
