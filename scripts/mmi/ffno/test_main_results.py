...
LastEditTime: 2023-09-12 17:01:43
'''
import os
import numpy as np
import subprocess
...
if __name__ == "__main__":
    ...
    tasks = [
        # ("rHz", 5, "random_size5", 12, "mm", 1, "./checkpoint/mmi/ffno/train_random/FFNO2d__err-0.1207_epoch-195.pt", 2),
        ("rHz", 5, "random_size5", 12, "mm", 1, "./checkpoint/mmi/ffno/Neurolight_L-12_tunableMMI.pt", 3),
    ]
    # tasks = [
    #     # ("slot_rHz", 10, "random_size10_slot", 16, "mm", 1, "./checkpoint/mmi/ffno/train_random/FFNO2d__err-0.3888_epoch-198.pt", 1),
    #     ("slot_rHz", 10, "random_size10_slot", 16, "mm", 1, "./checkpoint/mmi/ffno/Neurolight_L-16_etchedMMI.pt", 2),
    # ]
