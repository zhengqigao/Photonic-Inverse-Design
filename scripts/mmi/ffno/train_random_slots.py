...
LastEditTime: 2023-09-12 01:30:21
'''
import os
import subprocess
...
def task_launcher(args):
    ...
    with open(os.path.join(root, f'slot_rHz{n_data}_mixup-{mixup}_loss-{loss}_enc-{enc}_nl-{n_layer}_tv-{aux_loss_w:.4f}_id-{id}.log'), 'w') as wfid:
        exp = [
            ...
            # f"--model.mode_list={[(40, 100)]*n_layer}",
...
if __name__ == '__main__':
    ...
    # tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 12, 2]] # 41,193
    # tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 12, 3]] # 40, 100
    # tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 12, 4]] # 41, 193, dim=48
    tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 12, 5]] # 40, 70, dim=64, droppath=0.1
    tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 16, 6]] # 40, 70, dim=64, droppath=0.1, no augpath
    tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp_full", 10, 16, 7]] # 40, 70, dim=64, droppath=0.1, no augpath
    tasks = [
        # [1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 16, 8]
        [1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 5, 16, 9]
    ] # 40, 70, dim=64, droppath=0.1, no augpath, new seed
    
    # tasks = [
    #     [1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 16, 42],
    #     [1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 16, 0],
    # ] # 40, 70, dim=64, droppath=0.1, no augpath, new seed

    tasks = {
        "en4192928ul": tasks[0:1],
        # "eda05": tasks[2:3],
        # "eda14": tasks[3:4],
    }
    print(tasks)
