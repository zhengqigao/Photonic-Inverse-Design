...
LastEditTime: 2023-09-16 19:47:29
'''
import os
import subprocess
...
if __name__ == '__main__':
    ...
    tasks = [
        ...
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.03, 0.03, 1,   1,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.05, 0.05, 1,   1,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.07, 0.07, 1,   1,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.09, 0.09, 1,   1,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.11, 0.11, 1,   1,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.15, 0.15, 1,   1,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0.2,   0.2, 1,   1,   "fp32", "fp32", 10, 1],
    ][::-1]

    # scam downsampling factor
    tasks = [
        # [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 1,    1,   "fp32", "fp32", 100, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 0.8,0.8,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 0.7,0.7,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 0.6,0.6,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 0.5,0.5,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 0.4,0.4,   "fp32", "fp32", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0, 0, 0.333,0.333,"fp32","fp32", 10, 1],
    ...
    tasks = [
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "fp16", "fp16", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "bfp16","bfp16",10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "int16","int16",10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "int8", "int8", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "int7", "int7", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "int6", "int6", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "int5", "int5", 10, 1],
        [1, "cmae", True, "tv_loss", 0.00, True, 0.001, "exp", 5, 5, 0,    0,    1,   1,   "int4", "int4", 10, 1],
    ]
