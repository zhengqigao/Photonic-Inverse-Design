...
LastEditTime: 2023-09-15 14:13:46
'''
import os
import subprocess
...
dataset = "mmi"
model = "fno"
exp_name = "train_random_slot_noise"
...
def task_launcher(args):
    ...
    mixup, loss, loss_norm, aux_loss, aux_loss_w, aux_loss_norm, lr, enc, n_data, n_layer, in_std, tar_std, in_scale, tar_scale, in_prec, tar_prec, id = args
...
if __name__ == '__main__':
    ...
    tasks = [
        # [1, "cmae", True, "tv_loss", 0.001, True, 0.001, "exp", 10, 5, 0.001, 0.03, 1,   1,   "fp32", "fp32", 1],
        # [1, "cmae", True, "tv_loss", 0.001, True, 0.001, "exp", 10, 5, 0.001, 0.05, 1,   1,   "fp32", "fp32", 1],
        # [1, "cmae", True, "tv_loss", 0.001, True, 0.001, "exp", 10, 5, 0,    0,    0.8, 0.8, "fp32", "fp32", 1],
        # [1, "cmae", True, "tv_loss", 0.001, True, 0.001, "exp", 10, 5, 0,    0,    0.6, 0.6, "fp32", "fp32", 1],
        [1, "cmae", True, "tv_loss", 0.001, True, 0.001, "exp", 10, 5, 0,    0,    1,   1,   "int8", "int8", 1],
    ]
