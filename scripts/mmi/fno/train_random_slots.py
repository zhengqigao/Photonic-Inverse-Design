...
LastEditTime: 2022-03-21 01:43:12
'''
import os
import subprocess
...
if __name__ == '__main__':
    ...
    # tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 5, 5, 1]] # deep, bsconv stem, augpath, pre_norm after f_conv
    tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 5, 1]] # deep, bsconv stem, augpath, pre_norm after f_conv
